...
const adminStats = async () => {
    const [totalUsers, adminCount, customerCount, totalCategories, totalProducts,] = await prisma.$transaction([
        prisma.user.count(),
